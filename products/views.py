...
def add_product(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(
                request, 'Failed to add product, please double check the form'
               )
    else:
        form = ProductForm()
...
def edit_product(request, product_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(
                request,
                'Failed to update product. Please double check the form.'
                )
    else:
        form = ProductForm(instance=product)
        if product.subtitle:
            messages.info(
                request, f'You are editing {product.name} - {product.subtitle}'
                )
        else:
